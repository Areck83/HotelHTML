...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-6 col-md-8 col-sg-8 fondos"><p>Hola, bienvenido a nuestro sitio de reservaciones.
       Mira nuestro video de presentación para que tengas mayor información de lo que podrás realizar en nuestro sitio.
      <video src="img/Syn.mp4" controls width="90%" height="80%"></video></p>
      <p>
...
<div class="footer-copyright text-center py-3">© 2018 Copyright: HotelTrivago
  <a class="cierre" href="cerrarSes.php">Cerrar Sesión</a>
</div>
<!-- Copyright -->
</footer>
</body>
